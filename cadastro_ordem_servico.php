                    ...
                    <table>
                        ...
                        while ($dados = mysqli_fetch_array($restultado)) {
                            ...
                            <tr class="red-text">
                                ...
                                <td> ' .$nome_reserva = $dados['nome']  . '</td>
                                <td> ' .$cpf_reserva  =  $dados['cpf']  . '</td>
                              </tr>
                            </tbody>
                            </table>
                            ';
...
<button class="btn waves-effect waves-light" type="submit" name="action">Submit
    <i class="material-icons right">send</i>
            ...
            ';
                        ...
                        $nome_reserva1 =  @$_POST[$nome_reserva]; 
                        
                        $cpf_reserva1 =  @$_POST[$cpf_reserva]; 
                        ...
                        echo "Nome escolhido: " .$nome_reserva1."<br>";
                        echo "cpf escolhido: " .$cpf_reserva1."<br>";
                        
                        $nome = $inserir = $conn->query("INSERT INTO ordem_servico VALUES
                                (0,'$nome_reserva1','$cpf_reserva1','$placa','$nome_veiculo','$marca','$descricao01',
